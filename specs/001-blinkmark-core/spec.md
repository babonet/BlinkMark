...
- The maximum accepted upload size is 20 MB per file, and supported extensions are `.html`, `.htm`, `.md`, and `.markdown`. These are configurable operational limits rather than product promises.
