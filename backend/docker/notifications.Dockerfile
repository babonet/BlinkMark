...
#
# BlinkMark notification dispatcher. Same image as the reconciliation job; the role is selected
# by BlinkMark__Jobs__Role at run time.
...
ENV DOTNET_RUNNING_IN_CONTAINER=true \
    DOTNET_NOLOGO=1 \
    BlinkMark__Jobs__Role=notifications
